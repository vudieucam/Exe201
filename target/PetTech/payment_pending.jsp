...
<html>
    <head>
        ...
        <!-- Style + countdown (chỉ cần xuất hiện 1 lần trên trang) -->
        <style>
            body{
                background:#fffaf4;
    ...
    <body>
        ...
        <c:if test="${not empty param.err}">
            <div class="alert alert-danger text-center shadow-sm mb-3">
                ${param.err}
            </div>
        </c:if>
        ...
        <p>DEBUG paymentId: ${paymentId}</p>
        <!-- Hộp chờ duyệt thanh toán -->
        <div class="d-flex justify-content-center my-5">
            <div class="alert alert-wait mt-4">
                <!-- Thêm paymentId vào thông báo -->
                Mã giao dịch: <strong>${paymentId}</strong><br>
                💌 <strong>Cảm ơn bạn đã tin tưởng và lựa chọn <span style="color: #D97706;">PetTech</span>!</strong><br/>
                Sau khi bạn hoàn tất chuyển khoản, vui lòng <strong>chờ trong vòng tối đa 5 phút</strong> để chúng tôi xác nhận thanh toán.
            </div>
        </div>
    </div>
    <!-- Footer -->
