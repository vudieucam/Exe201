...
<body>
    <div class="container my-5 p-4 bg-light bg-opacity-75 rounded-4 shadow-lg">
        ...
        <form action="authen?action=changePassword" method="post">
            ...
            <div class="d-grid mt-4">
                <button class="btn btn-save" type="submit"><i class="fas fa-save"></i> Save</button>
            </div>
        </form>
    </div>
    ...
    <script>
        // Bạn có thể xử lý chuyển hướng về login trong backend,
        // hoặc sử dụng JavaScript nếu API trả về thành công.
        // Ví dụ (sau khi xử lý backend):
