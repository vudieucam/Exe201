    ...
    <body>
                ...
                <div class="col-md-10 p-4">
                    ...
                    <div class="filter-section">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="order-method-filter">
                            ...
                            <div class="col-md-3">
                                <label class="form-label filter-title">Ngày đặt</label>
                                <select class="form-select" id="order-date-filter">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="order-search" placeholder="Mã đơn hàng...">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <div class="btn-group">
                                    <button class="btn btn-sm btn-outline-secondary active">Tất cả (324)</button>
                                    <button class="btn btn-sm btn-outline-secondary">Chờ xử lý (42)</button>
                                    <button class="btn btn-sm btn-outline-secondary">Đang xử lý (28)</button>
                                    <button class="btn btn-sm btn-outline-secondary">Hoàn thành (248)</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-hover" id="orders-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-outline-primary action-btn" data-bs-toggle="modal" data-bs-target="#orderDetailModal">
                                                    <i class="bi bi-eye"></i>
                                                </button>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="orderDetailModalLabel">Chi tiết đơn hàng #ORD-2306001</h5>
                    ...
                    <div class="modal-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card p-3">
                                    <p class="mb-1"><strong>Mã đơn:</strong> ORD-2306001</p>
                                    <p class="mb-1"><strong>Ngày đặt:</strong> 15/06/2023 09:30</p>
                                    <p class="mb-1"><strong>Phương thức:</strong> Chuyển khoản</p>
                                    <p class="mb-0"><strong>Trạng thái:</strong> <span class="status-badge status-active">Hoàn thành</span></p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <p class="mb-0">Thức ăn cho chó Royal Canin</p>
                                                    <small class="text-muted">Loại: 10kg</small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>₫1,200,000</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="https://via.placeholder.com/50" class="me-2" style="width: 50px; height: 50px; object-fit: cover;">
                                                <div>
                                                    <p class="mb-0">Vòng cổ chó mèo</p>
                                                    <small class="text-muted">Màu: Đỏ, Size: M</small>
                                                </div>
                                            </div>
                                        </td>
                                        <td>₫250,000</td>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card p-3 mb-3">
                                    ...
                                    <p class="mb-0">Giao hàng trước 17h chiều ngày 16/06/2023</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card p-3">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="mb-3">
                                <label for="order-status" class="form-label">Trạng thái hiện tại</label>
                                <input type="text" class="form-control" id="current-status" value="Chờ xử lý" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="new-status" class="form-label">Cập nhật trạng thái</label>
                            ...
                            <div class="mb-3">
                                <label for="status-note" class="form-label">Ghi chú</label>
        ...
        <script>
            ...
            document.getElementById('search-btn').addEventListener('click', function() {
                ...
                const methodFilter = document.getElementById('order-method-filter').value;
                ...
                rows.forEach(row => {
                    ...
                    const matchSearch = orderCode.includes(searchText) || customerName.includes(searchText);
                    const matchStatus = statusFilter === 'all' || 
                        (statusFilter === 'pending' && status === 'Chờ xử lý') ||
                        (statusFilter === 'processing' && status === 'Đang xử lý') ||
                        (statusFilter === 'completed' && status === 'Hoàn thành') ||
                        (statusFilter === 'cancelled' && status === 'Đã hủy');
                    
                    // In a real app, you would also check method and date filters
