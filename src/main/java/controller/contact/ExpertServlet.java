...
public class ExpertServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ExpertServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ExpertServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            /* Đưa danh sách chuyên gia sang JSP */
            request.setAttribute("experts", experts);
        } catch (Exception e) {
            /* Log lỗi (prod có thể redirect hoặc set message) */
            e.printStackTrace();
            request.setAttribute("experts", null);
        }
