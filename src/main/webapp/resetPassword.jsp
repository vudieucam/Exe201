        ...
        <div class="container my-5 p-4 bg-light bg-opacity-75 rounded-4 shadow-lg">
            ...
            <form action="authen?action=resetpassword" method="post">
                <div class="mb-3 form-floating">
                    <input name="email" type="email" class="form-control" id="email" placeholder="Email của bạn" required autocomplete="email" value="${param.email}">
            ...
            <a href="authen?action=login" class="back-link">
