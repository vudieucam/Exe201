...
VALUES 
(N'Cách chăm sóc chó con 3 tháng tuổi đầu tiên ', N'Sau khi sinh, chó con cũng cần được chăm sóc đặc biệt dù không có sự hiện diện của chó mẹ. Nếu bạn chưa biết cách chăm sóc chó con mới đẻ phù hợp và đúng đắn, hãy cùng PetTech khám phá thông tin trong bài viết dưới đây.', GETDATE(), N'Dr. Nam Nguyễn', NULL, 1, N'4 tuần', '/images/course/course1.jpg'),

(N'Cách chăm sóc mèo con ', N'Để có được một chú mèo khỏe mạnh và đáng yêu thì việc chăm sóc đúng cách, cẩn thận là một điều cần thiết và quá trình đó bắt đầu từ lúc chú mèo vừa lọt lòng mẹ. Thế nên, hôm nay hãy cùng PetTech tìm hiểu về cách nuôi và chăm sóc mèo con mới đẻ đơn giản nhất.
Nuôi và chăm sóc thú cưng dường như là cả một quá trình dài và cần nhiều sự kiên nhẫn, vì mỗi giai đoạn thì vật nuôi nhà bạn sẽ cần một phương thức chăm sóc khác nhau và loài mèo cũng vậy. Để biết được cách nuôi và chăm sóc mèo con mới đẻ đơn giản nhất thì hãy theo dõi bài viết này nhé.', GETDATE(), N'Dr. Hiền Nguyễn', NULL, 1, N'6 tuần', '/images/course/course2.jpg'),



(N'Cách vệ sinh cho chó', N'Thú cưng được chăm sóc thường xuyên sẽ luôn sạch sẽ, khỏe mạnh và hạnh phúc. Nhiều người thích sử dụng dịch vụ chăm sóc vệ sinh vật nuôi chuyên nghiệp để tân trang vẻ ngoài cũng như bảo đảm an toàn cho chúng. Tuy nhiên, nếu tại địa phương không có dịch vụ này hoặc muốn tiết kiệm tiền, bạn có thể tự vệ sinh cho chó tại nhà.', GETDATE(), N'Dr. Chi Nguyễn', NULL, 1, N'3 tháng', '/images/course/course3.jpg'),

(N'Huấn luyện chó căn bản', N'Hướng dẫn chi tiết các kỹ thuật huấn luyện chó cơ bản', GETDATE(), N'Dr. Thanh Phạm', NULL, 1, N'5 tuần', '/images/course/course4.jpg'),

(N'Chăm sóc mèo cơ bản', N'Hướng dẫn chi tiết chăm sóc mèo từ thức ăn, vệ sinh, đến sức khỏe.', GETDATE(), N'Dr. Mai Phương', NULL, 1, N'4 tuần', '/images/course/course5.jpg');
...
VALUES
(1 , N'Module 1: Những cách chăm sóc chó con mới đẻ cần ghi nhớ', N'Như các bạn đã biết, chó con mới đẻ thường có sức khỏe khá yếu. Vậy làm thế nào để chúng ta có thể nuôi dưỡng chúng một cách tốt nhất?', 1),

(1 , N'Module 2: Một số lưu ý về chế độ dinh dưỡng cho chó con mới đẻ', N'Hướng dẫn lựa chọn chế độ ăn phù hợp theo độ tuổi', 2),

(2 , N'Module 1: Cách chăm sóc mèo con mới đẻ vẫn còn mẹ', N'Hiểu về cách chăm sóc cho mèo con mới đẻ', 1),

(2 , N'Module 2: Cách chăm sóc mèo con mới đẻ mất mẹ', N'Để chăm sóc mèo con mới đẻ mất mẹ, bạn cần tạo một môi trường sống ấm áp và an toàn cho chúng. Chuẩn bị một chiếc chuồng hoặc tổ ấm có lót khăn mềm,...', 1),

(2 , N'Module 3: Các loại sữa bột tốt cho mèo con', N'Các loại sữa công thức phù hợp cho mèo con, ...', 1),

(2 , N'Module 4: Lưu ý khi chăm sóc mèo con mới đẻ', N'- Không nên để mèo nằm khi ăn vì như vậy dễ gây sặc và tràn vào phổi.
...
- Nếu mèo mất mẹ, bạn cần phải tập trung quan sát những thay đổi cơ thể của chúng để biết được cách thức chăm sóc hợp lý.', 1),

(3 , N'Module 1: Vệ sinh cho chó trước khi tắm', N'Xem bài học bên dưới ... ', 1),

(4 , N'Module 2: Lưu ý khi chăm sóc mèo con mới đẻ', N'- Không nên để mèo nằm khi ăn vì như vậy dễ gây sặc và tràn vào phổi.
- Với giai đoạn đầu bạn không nên tắm thường xuyên cho mèo vì ảnh hưởng đến sức đề kháng của chúng, và khi tắm nên dùng nước ấm để tránh tình trạng sốc nhiệt, làm mèo giật mình.
- Nếu mèo mất mẹ, bạn cần phải tập trung quan sát những thay đổi cơ thể của chúng để biết được cách thức chăm sóc hợp lý.', 1);
...
VALUES
(1, N'Bài 1 . Vệ sinh ổ đẻ cho các chú cún con đảm bảo sạch sẽ', N'Sau khi trải qua quá trình sinh, chó mẹ thường dành phần lớn thời gian để nghỉ ngơi bên cạnh đàn con của mình, chỉ rời khỏi để đi vệ sinh hoặc ăn uống. Chúng ta có thể tận dụng thời gian này để làm vệ sinh, quét dọn và thay khăn lót ổ đẻ. Đảm bảo môi trường ổ đẻ khô ráo và thoáng mát là cách giúp ngăn ngừa sự phát triển của vi khuẩn và bảo vệ sức khỏe cho chó con non nớt.
Tuy nhiên, các bạn cần lưu ý không nên lót quá nhiều lớp vải trong ổ đẻ. Điều này giúp tránh tình trạng chó con chưa mở mắt gặp khó khăn trong việc tìm hiểu phương hướng và không thể tìm đến chó mẹ để bú.', NULL, 10, 1),

(1, N'Bài 2 . Chú ý làm sạch cơ thể cho cún con mới sinh', N'Hầu hết chó con khi mới sinh ra sẽ có lớp nhầy nhớt hoặc vết bẩn từ nước ối. Để làm sạch, bạn nên sử dụng một khăn mềm thấm nước ấm và nhẹ nhàng lau cho đến khi sạch. Đây là một bước quan trọng trong quá trình chăm sóc chó con mới sinh.
...
Trong những ngày đầu, chó con sẽ có cuống rốn còn dính trên bụng. Bạn không nên cắt nó quá sớm vì điều này có thể gây ra xuất huyết và chảy máu cho chó con. Hãy để cuống rốn tự teo dần theo thời gian và không cần lo lắng về điều này.', NULL, 15, 2),
...
Bằng cách sử dụng phương pháp trên, bạn có thể nuôi chó con mới sinh một cách tốt nhất, giúp chúng phát triển khỏe mạnh và tăng trưởng nhanh chóng.', NULL, 20, 3),
...
Nếu ổ đẻ quá nóng, chó con sẽ nằm xa nhau, kêu và quậy nhiều. Nếu ổ đẻ quá lạnh, chó con sẽ rúc vào nhau. Vì vậy, dựa vào những dấu hiệu này, chúng ta cần tạo một môi trường sống thích hợp nhất để giúp chó con mới sinh phát triển.', NULL, 15, 4),
...
Hãy thực hiện tốt các bước trên nếu không muốn thú cưng bị mắc bệnh và không muốn mầm bệnh này lây lan nhanh chóng ra các chú chó khác trong đàn nhé!', NULL, 10, 5),
...
Trước khi tiêm phòng, bạn nên hỏi cặn kẽ bác sĩ về kế hoạch tiêm để có thể thực hiện đầy đủ, đúng thời gian. Mũi tiêm đúng thời điểm sẽ phát huy hết công dụng và có thể bảo vệ tốt sức khỏe cho chó con.', NULL, 5, 6),
...
Khi chó con mở mắt được vài ngày, bạn có thể bắt đầu cho chúng làm quen với việc ăn dặm bằng món cháo nấu loãng với thịt. Sau khi chó con đã quen tiêu hóa các thức ăn ngoài, hãy bổ sung thêm rau, củ trong khẩu phần ăn của chúng hàng ngày.', NULL, 5, 7),
...
Trên đây là chia sẻ cách chăm sóc chó con mới đẻ của PetTech. Nếu bạn có nhu cầu mua sữa hay các sản phẩm thức ăn cho vật nuôi của mình, hãy liên hệ PetTech để được tư vấn.','https://youtube.com/embed/123', 20, 1),
...
Nhưng đặc biệt khi lúc sinh, bạn nên đứng quan sát từ xa, hạn chế việc lại gần gây mất tập trung cho mèo mẹ. Song, bạn nên chuẩn bị một tô cháo loãng để mèo mẹ lấy lại sức sau khi sinh.', NULL, 3, 1),

(3, N'Bài 2: Dinh dưỡng cho mèo mẹ', N'Sau khi sinh xong là thời điểm bạn nên quan tâm đến chế độ dinh dưỡng của chúng bởi mèo mẹ đang cần nhiều sữa để cho mèo con, Thế nên, bạn nên cung cấp những loại thức ăn cho mèo hoặc thực phẩm mềm, dễ tiêu hóa có chứa hàm lượng tinh bột, protein và các dưỡng chất cần thiết khác.', 'https://youtube.com/embed/456', 2, 1),


(3, N'Bài 3: Dinh dưỡng cho mèo con', N'Với mèo con sau dinh thì chất dinh dưỡng tốt nhất đó chính là sữa mẹ, vì thế ở giai đoạn này bạn không cần can thiệp quá nhiều về chế độ dinh dưỡng của chúng. Nhưng bạn cũng phải quan sát nếu mèo mẹ không đủ sữa cung cấp thì bạn có thể hỗ trợ nguồn sữa ngoài cho chúng.', 'https://youtube.com/embed/456', 2, 1),
...
Bạn hãy kiên nhẫn lập lại việc này khoảng 3 - 4 lần thì mèo con sẽ tự nhận biết và trở thành thói quen, giúp việc chăm sóc mèo trở nên dễ dàng hơn.', 'https://youtube.com/embed/456', 2, 1),
...
Tốt nhất bạn nên sử dụng các hộp giấy có thành cao để làm ổ cho mèo, bên trong có lót chăn hay vải mềm để tạo sự thoải mái cho mèo và phải đảm bảo mức nhiệt độ khoảng 37 độ C để giữ ấm cho mèo.', 'https://youtube.com/embed/456', 2, 1),
...
- Mèo 2-3 tháng tuổi: Ngoài sữa bạn có thể tập cho chúng các loại thức ăn mềm, tần suất dùng sữa giảm lại (2 lần/ngày).', 'https://youtube.com/embed/456', 5, 1),
...
Giá bán: 35.000 đồng/100gr', 'https://youtube.com/embed/456', 5, 1),
...
Giá bán: 250.000 đồng/300gr
Sữa Royal Canin Babycat Milk', 'https://youtube.com/embed/456', 7, 1),
...
Cho mèo sơ sinh: Pha sữa theo tỉ lệ 1 sữa, 2 nước, mỗi ngày cho mèo bú 15ml – 25ml sữa PetLac 5 – 6 lần, cho bú lại sau mỗi 2 – 3 giờ.
Cho mèo con, lớn hơn 2 tháng: Pha theo tỉ lệ 1 - 4 tùy theo khẩu vị và nhu cầu dinh dưỡng của mèo.
Giá bán: 250.000 đồng/300gr', 'https://youtube.com/embed/456', 7, 1),
...
Giá bán: 561.000 đồng/300gr', 'https://youtube.com/embed/456', 8, 1),
...
Giá bán: 180.000 đồng/400gr', 'https://youtube.com/embed/456', 7, 1),
...
Giá bán: 35.000 đồng/100gr', 'https://youtube.com/embed/456', 2, 1),
...
Việc âu yếm chúng thường xuyên là điều không nên vì cơ thể chúng còn nhỏ, đề kháng còn yếu nên việc làm này có thể khiến chúng khó thích nghi và chậm phát triển so với bình thường.', 'https://youtube.com/embed/456', 2, 1),
...
Bạn không nên thực hiện tiêm phòng cho mèo trong giai đoạn làm quen và tiếp xúc với môi trường mới vì nó sẽ không đem lại hiệu quả cao.', 'https://youtube.com/embed/456', 2, 1),
...
Ví dụ, phương pháp để diệt bọ chét và sâu là sử dụng sản phẩm như: Stronghold của Anh, Revolution của Mỹ…để thoa lên phần da ở sau gáy, tối đa 2 lần một tháng.', 'https://youtube.com/embed/456', 2, 1),
...
Bước 4: Nếu mèo gặp khó khăn khi đi vệ sinh, đừng trừng phạt hay la mắng mèo. Làm như vậy sẽ chỉ dẫn đến căng thẳng và lo lắng, điều này sẽ làm trầm trọng thêm vấn đề và khiến việc sử dụng cát để huấn luyện mèo trở nên khó khăn hơn.', 'https://youtube.com/embed/456', 10, 1),


(6, N'Bài 4: Các bệnh thường gặp ở mèo con', N'Sán dây: Bác sĩ thú y thường điều trị sán dây ở mèo con bị bọ chét truyền bệnh. Tuy nhiên, bạn có thể được yêu cầu lấy mẫu phân mèo con vì bạn dễ bị nhiễm các loại ký sinh trùng khác như nấm ngoài da.
...
PetTech đã gửi đến bạn thông tin về cách nuôi và chăm sóc mèo con mới đẻ đơn giản nhất. Nếu bạn đang chuẩn bị nuôi một chú mèo thì lượng kiến thức này là vô cùng cần thiết nhé!', 'https://youtube.com/embed/456', 2, 1),

(7, N'Bài 1: Các bước vệ sinh cho chó', N'Chuẩn bị dụng cụ. Bạn nên xếp sẵn đồ đạc trước khi bắt đầu chải chuốt cho cún cưng nhằm tạo điều kiện thuận lợi cho cả hai.
...
Bước này cực kỳ quan trọng đối với chó con, những chú cún được huấn luyện từ nhỏ để làm quen với thao tác này.
...
Cắt móng cho chó. Nếu không được cắt, móng sẽ mọc dài và đâm vào đệm thịt hoặc siết chặt ngón chân gây tổn hại khớp xương. Bạn cần cắt tỉa móng cho chó thường xuyên để duy trì độ dài thích hợp, tùy thuộc vào tốc độ mọc của móng. Nếu bạn nghe tiếng móng chạm đất thì có nghĩa là móng đã mọc quá dài. [5]
...
Nếu cắt quá sâu và đụng phải mạch máu, bạn có thể dùng bột cầm máu, bột bắp, hoặc bột mì dặm lên vết thương để ngăn máu không tiếp tục chảy.', 'https://youtube.com/embed/456', 45, 1),

(7, N'Bài 2: Tắm cho chó', N'Chuẩn bị dụng cụ. Bạn cần xếp sẵn vật dụng thay vì chạy quanh đi tìm đồ đạc trong lúc chú cún đang ướt đẫm người. Hơn nữa, bạn nên mặc quần áo mà bạn không ngại bị bẩn vì sẽ không tránh khỏi bị ướt. Sau đó, bạn hãy chuẩn bị ít nhất những dụng cụ sau: 
Dầu gội dành cho chó
Thức ăn vặt
Vài chiếc khăn
Trải một chiếc khăn lên cạnh bồn để nước không văng ra ngoài, còn những khăn khác dùng để lau khô thú cưng.
Trải miếng chống trượt dưới đáy bồn. Bề mặt của bồn tắm thường rất trơn trượt nếu dính xà phòng. Để chú cún không bị trượt ngã, bạn nên trải khăn hoặc miếng chống trượt dưới đáy bồn.
Xả nước ấm vào bồn. Nước nóng có thể làm tổn hại đến da chó, đặc biệt nếu chúng có lông ngắn. Không nên xả nước khi chú cún đang ở trong bồn vì điều này có thể làm chúng căng thẳng. Bạn nên dành thời gian tập cho thú cưng làm quen với âm thanh của tiếng nước chảy bằng món ăn ưa thích của chúng. Luôn thực hiện từ từ để tránh gây áp lực cho chú cún và khó khăn cho cả hai.
...
Thay vòng cổ thông thường bằng loại không thấm màu ra bộ lông hoặc bị hư hại khi gặp nước.
...
Nếu chú cún sợ âm thanh hoặc cảm giác khi tiếp xúc với máy sấy, bạn không nên ép buộc chúng. Thay vào đó, hãy dùng khăn lau và dắt chó vào nơi phù hợp để lông chó khô tự nhiên, chẳng hạn như trong phòng giặt.', 'https://youtube.com/embed/456', 25, 1),

(7, N'Bài 3: Tỉa lông chó', N'Cân nhắc tỉa lông cho thú cưng. Nhiều giống chó có lông ngắn và không cần phải cắt tỉa thường xuyên. Tuy nhiên, nếu chú cún có bộ lông dày, bạn cần tỉa thường xuyên để chúng luôn khỏe mạnh. Những giống chó cần tỉa lông thường xuyên bao gồm cocker spaniel, chó chăn cừu, chó xù, collie, chó sư tử, chó Bắc Kinh, và Đường Khuyển.
...
Kiên nhẫn. Bạn cần phải rà nhiều đường trên lông chó mới có được đường cắt mềm mịn và thẳng tắp. Không nên vội vàng! Cho phép thú cưng nghỉ ngơi càng nhiều càng tốt, và phải di chuyển tông đơ nhẹ nhàng.', 'https://youtube.com/embed/456', 20, 1);
